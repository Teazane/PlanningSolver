...
# TODO
# Voeux de Scean
scean_wish_1 = Wish(scean, stonebelow, 11)
scean_wish_2 = Wish(scean, vaesen, 10)
scean_wish_3 = Wish(scean, veggie_patch, -1)
scean_wish_4 = Wish(scean, ten_candles, -1)
scean_wish_5 = Wish(scean, zombie, 15)
scean_wish_6 = Wish(scean, bebop, 13)
scean_wish_7 = Wish(scean, lalaland, -1)
scean_wish_8 = Wish(scean, tftl, 14)
scean_wish_9 = Wish(scean, magical_girl, 12)
scean_wish_10 = Wish(scean, ryuutama, -1)
scean_wish_11 = Wish(scean, root, -1)
scean_wish_12 = Wish(scean, scion, -1)
# Voeux de Thomas
